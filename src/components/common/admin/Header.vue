<template>
    <div class='header'>
        ...
        <div class='logo'>SMALLFROG书店</div>
            ...
            <div class='header-user-con'>
                ...
                <el-dropdown @command='handleCommand' class='user-name' trigger='click'>
                    ...
                    <el-dropdown-menu slot='dropdown'>
                        <el-dropdown-item command='modify' divided>修改资料</el-dropdown-item>
    ...
    export default {
        data() {
            return {
                ...
                name: 'zhanzihao',
                message: 0,
                defaultAvatar: 'http://localhost:9527/static/defaultAvatar.jpg'
            };
        },
        computed: {
            username() {
            ...
            avatar() {
                let avatar = localStorage.getItem('ms_avatar');
